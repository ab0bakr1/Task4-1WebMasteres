                                ...
                                <Card.Body className='Categories-body'>
                                    <div className="">
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_6470_868)">
                        ...
                        <Col>
                            <Card className="Categories-card">
                                <Card.Body className='Categories-body'>
                                    <div className="">
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_6470_613)">
                                            ...
                                            <defs>
                                                <clipPath id="clip0_6470_613">
                                                    <rect width="56" height="56" fill="white"/>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </div>
                                    <div className="Categories-title">Computers</div>
                                </Card.Body>
                            </Card>
                        </Col>
                    </SwiperSlide>
                        ...
                        <Col>
                            <Card className="Categories-card">
                                <Card.Body className='Categories-body'>
                                    <div className="">
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_6470_629)">
                                            ...
                                            <defs>
                                                <clipPath id="clip0_6470_629">
                                                    <rect width="56" height="56" fill="white"/>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </div>
                                    <div className="Categories-title">SmartWatch</div>
                                </Card.Body>
                            </Card>
                        </Col>
                    </SwiperSlide>
                                ...
                                <Card.Body className='Categories-body'>
                                    <div className="">
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <defs>
                                                <clipPath id="clip0_6470_6">
                                                    <rect width="56" height="56" fill="white"/>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </div>
                                    <div className="Categories-title">Camera</div>
                                </Card.Body>
                            </Card>
                        </Col>
                    </SwiperSlide>
                        ...
                        <Col>
                            <Card className="Categories-card">
                                <Card.Body className='Categories-body'>
                                    <div className="">
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_6470_644)">
                        ...
                        <Col>
                            <Card className="Categories-card">
                                <Card.Body className='Categories-body'>
                                    <div className="">
                                        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_6470_809)">
                                            ...
                                            <defs>
                                                <clipPath id="clip0_6470_809">
                                                    <rect width="56" height="56" fill="white"/>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </div>
                                    <div className="Categories-title">Gaming</div>
                                </Card.Body>
                            </Card>
                        </Col>
                    </SwiperSlide>
